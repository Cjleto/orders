...
'cors.allowed_headers','cors.exposed_headers','cors.max_age','cors.supports_credentials','sanctum.stateful',
...
'log-viewer.files.download','log-viewer.index','loginLinkLogin','login','logout','register','password.request','password.email','password.reset','password.update',
'password.confirm','home','profile.show','profile.update',
'toggle.theme','admin.home','roles.index','roles.create','roles.store',
'roles.edit','roles.update','users.index','users.create','users.store',
'users.edit','users.update','users.destroy','customers.index','customers.create',
'customers.store','customers.show','customers.edit','customers.update','customers.destroy',
'products.index','products.show','products.create','orders.index','orders.show',
'orders.create',);
