...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'l5-swagger.defaults.securityDefinitions.security.0.sanctum.type' => 'string',
            'l5-swagger.defaults.securityDefinitions.security.0.sanctum.scheme' => 'string',
...
'filesystems.disks.media.throw','filesystems.links./var/www/html/public/storage','l5-swagger.default','l5-swagger.documentations.default.api.title','l5-swagger.documentations.default.api.description',
...
'l5-swagger.defaults.securityDefinitions.securitySchemes','l5-swagger.defaults.securityDefinitions.security.0.sanctum.type','l5-swagger.defaults.securityDefinitions.security.0.sanctum.scheme','l5-swagger.defaults.generate_always','l5-swagger.defaults.generate_yaml_copy',
...
'logging.channels.null.handler','logging.channels.emergency.path','login-link.allowed_environments','login-link.automatically_create_missing_users','login-link.user_model',
'login-link.redirect_route_name','login-link.login_link_controller','login-link.middleware','mail.default','mail.mailers.smtp.transport',
...
'media-library.prefix','media-library.force_lazy_loading','myconst.initial_role_permissions.admin','myconst.initial_role_permissions.customer','myconst.currency_symbol',
'myconst.cache_ttl_sec','permission.models.permission','permission.models.role','permission.table_names.roles','permission.table_names.permissions',
...
'log-viewer.index','api.logout','api.products.index','api.products.store',
'api.products.show','api.products.update','api.products.destroy','api.customers.index','api.customers.store',
'api.customers.show','api.customers.update','api.customers.destroy','api.orders.index','api.orders.store',
'api.orders.show','api.orders.update','api.orders.destroy','fallback','login','logout',
'register','password.request','password.email','password.reset',
'password.update','password.confirm','home','profile.show',
'profile.update','toggle.theme','admin.home','roles.index','roles.create',
'roles.store','roles.edit','roles.update','users.index','users.create',
'users.store','users.edit','users.update','users.destroy','customers.index',
'customers.create','customers.store','customers.show','customers.edit','customers.update',
'customers.destroy','products.index','products.show','products.create','orders.index',
'orders.show','orders.create',);
...
'home_admin','l5-swagger::index','layouts.app','layouts.guest','layouts.navigation',
'livewire.dashboard-container','livewire.order-create','livewire.order-index','livewire.order-show','livewire.ordini-chart',
'livewire.product-create','livewire.product-delete','livewire.product-edit','livewire.product-index','livewire.product-list-create-order',
'livewire.product-show','livewire::bootstrap','livewire::simple-bootstrap','livewire::simple-tailwind','livewire::tailwind',
'mail.test','preview','roles.create','roles.edit','roles.index',
'sweetalert::alert','users.create','users.edit','users.index','vendor.l5-swagger.index',
...
'volt-livewire::product-index','volt-livewire::product-list-create-order','volt-livewire::product-show','welcome','l5-swagger::index',
