...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'livewire.lazy_placeholder' => 'string',
            ...
            'login-link.allowed_environments' => 'array',
            'login-link.allowed_hosts' => 'array',
            'login-link.automatically_create_missing_users' => 'boolean',
            'login-link.user_model' => 'NULL',
            'login-link.redirect_route_name' => 'NULL',
            'login-link.login_link_controller' => 'string',
            'login-link.middleware' => 'array',
            'mail.default' => 'string',
            ...
            'myconst.initial_role_permissions.admin' => 'array',
            'myconst.initial_role_permissions.customer' => 'array',
...
'debugbar.debug_backtrace_limit','filesystems.default','filesystems.disks.local.driver','filesystems.disks.local.root','filesystems.disks.local.throw',
...
'filesystems.disks.media.root','filesystems.disks.media.url','filesystems.disks.media.visibility','filesystems.disks.media.throw','filesystems.links./var/www/html/public/storage',
...
'log-viewer.cache_key_prefix','log-viewer.lazy_scan_chunk_size_in_mb','log-viewer.strip_extracted_context','logging.default','logging.deprecations.channel',
...
'logging.channels.null.handler','logging.channels.emergency.path','login-link.allowed_environments','login-link.allowed_hosts','login-link.automatically_create_missing_users',
'login-link.user_model','login-link.redirect_route_name','login-link.login_link_controller','login-link.middleware','mail.default',
...
'media-library.default_loading_attribute_value','media-library.prefix','media-library.force_lazy_loading','myconst.initial_role_permissions.admin','myconst.initial_role_permissions.customer',
...
'sweetalert.height_auto','sweetalert.padding','sweetalert.background','sweetalert.animation.enable','sweetalert.animatecss',
...
'sweetalert.timer_progress_bar','sweetalert.middleware.autoClose','sweetalert.middleware.toast_position','sweetalert.middleware.toast_close_button','sweetalert.middleware.timer',
'sweetalert.middleware.auto_display_error_messages','sweetalert.customClass.container','sweetalert.customClass.popup','sweetalert.customClass.header','sweetalert.customClass.title',
'sweetalert.customClass.closeButton','sweetalert.customClass.icon','sweetalert.customClass.image','sweetalert.customClass.content','sweetalert.customClass.input',
'sweetalert.customClass.actions','sweetalert.customClass.confirmButton','sweetalert.customClass.cancelButton','sweetalert.customClass.footer','sweetalert.confirm_delete_confirm_button_text',
'sweetalert.confirm_delete_confirm_button_color','sweetalert.confirm_delete_cancel_button_color','sweetalert.confirm_delete_cancel_button_text','sweetalert.confirm_delete_show_cancel_button','sweetalert.confirm_delete_show_close_button',
'sweetalert.confirm_delete_icon','sweetalert.confirm_delete_show_loader_on_confirm','hashing.driver','hashing.bcrypt.rounds','hashing.bcrypt.verify',
...
'log-viewer.index','loginLinkLogin',
'login','logout','register',
'password.request','password.email','password.reset','password.update','password.confirm','home','profile.show','profile.update','toggle.theme',
'admin.home','roles.index','roles.create','roles.store','roles.show',
...
'auth.profile','auth.register','auth.verify','errors.419','errors.minimal',
'errors.settings.missing','errors.web-rendered','home','home_admin','layouts.app',
'layouts.guest','layouts.navigation','livewire::bootstrap','livewire::simple-bootstrap','livewire::simple-tailwind',
...
'vendor.livewire.tailwind','vendor.login-link.loginLink','vendor.login-link.loginLinkButton','vendor.sweetalert.alert','welcome',
...
'livewire::simple-bootstrap','livewire::simple-tailwind','livewire::tailwind','log-viewer::index','login-link::loginLink',
'login-link::loginLinkButton','media-library::image','media-library::placeholderSvg','media-library::responsiveImage','media-library::responsiveImageWithPlaceholder',
...
'validation.uuid','validation.custom.attribute-name.rule-name','validation.validation_invitation','validation.dish_update_error','en.0',
'allergens.Cereali.name','allergens.Cereali.description','allergens.Crostacei.name','allergens.Crostacei.description','allergens.Uova.name',
'allergens.Uova.description','allergens.Pesce.name','allergens.Pesce.description','allergens.Arachidi.name','allergens.Arachidi.description',
'allergens.Soia.name','allergens.Soia.description','allergens.Latte.name','allergens.Latte.description','allergens.Frutta a guscio.name',
'allergens.Frutta a guscio.description','allergens.Sedano.name','allergens.Sedano.description','allergens.Senape.name','allergens.Senape.description',
'allergens.Semi di sesamo.name','allergens.Semi di sesamo.description','allergens.Anidride solforosa e solfiti.name','allergens.Anidride solforosa e solfiti.description','allergens.Lupini.name',
'allergens.Lupini.description','allergens.Molluschi.name','allergens.Molluschi.description','allergens.footer_msg','helpinfo.SetVisibility',
'helpinfo.EditDish','helpinfo.AssignAllergens','helpinfo.AssignPeculiarities','helpinfo.AssignPartialPrice','helpinfo.DragDropOrder',
'helpinfo.EditDetails','helpinfo.goToCategories','helpinfo.goToSubCategories','helpinfo.goToDishes','helpinfo.goToAllergens',
'helpinfo.goToMacroCategories','helpinfo.goToCompanies','helpinfo.goToUsers','helpinfo.goToRoles','helpinfo.goToProfile',
'publicmenu.google_review_msg','it.0',);
...
'DB_DATABASE','DB_USERNAME','DB_PASSWORD','FORWARD_DB_PORT','SESSION_DRIVER',
...
'AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','VITE_PORT','SAIL_XDEBUG_MODE',
'SAIL_XDEBUG_CONFIG',);
