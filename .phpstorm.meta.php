...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'myconst.currency_symbol' => 'string',
            'myconst.cache_ttl_sec' => 'integer',
...
'filesystems.disks.media.throw','filesystems.links./var/www/html/public/storage','livewire.class_namespace','livewire.view_path','livewire.layout',
...
'logging.channels.errorlog.replace_placeholders','logging.channels.null.driver','logging.channels.null.handler','logging.channels.emergency.path','login-link.allowed_environments',
'login-link.allowed_hosts','login-link.automatically_create_missing_users','login-link.user_model','login-link.redirect_route_name','login-link.login_link_controller',
'login-link.middleware','mail.default','mail.mailers.smtp.transport','mail.mailers.smtp.url','mail.mailers.smtp.host',
...
'myconst.initial_role_permissions.admin','myconst.initial_role_permissions.customer','myconst.currency_symbol','myconst.cache_ttl_sec','permission.models.permission',
...
'sweetalert.theme','sweetalert.cdn','sweetalert.alwaysLoadJS','sweetalert.neverLoadJS','sweetalert.timer',
'sweetalert.width','sweetalert.height_auto','sweetalert.padding','sweetalert.background','sweetalert.animation.enable',
'sweetalert.animatecss','sweetalert.show_confirm_button','sweetalert.show_close_button','sweetalert.button_text.confirm','sweetalert.button_text.cancel',
'sweetalert.toast_position','sweetalert.timer_progress_bar','sweetalert.middleware.autoClose','sweetalert.middleware.toast_position','sweetalert.middleware.toast_close_button',
'sweetalert.middleware.timer','sweetalert.middleware.auto_display_error_messages','sweetalert.customClass.container','sweetalert.customClass.popup','sweetalert.customClass.header',
'sweetalert.customClass.title','sweetalert.customClass.closeButton','sweetalert.customClass.icon','sweetalert.customClass.image','sweetalert.customClass.content',
'sweetalert.customClass.input','sweetalert.customClass.actions','sweetalert.customClass.confirmButton','sweetalert.customClass.cancelButton','sweetalert.customClass.footer',
'sweetalert.confirm_delete_confirm_button_text','sweetalert.confirm_delete_confirm_button_color','sweetalert.confirm_delete_cancel_button_color','sweetalert.confirm_delete_cancel_button_text','sweetalert.confirm_delete_show_cancel_button',
'sweetalert.confirm_delete_show_close_button','sweetalert.confirm_delete_icon','sweetalert.confirm_delete_show_loader_on_confirm','hashing.driver','hashing.bcrypt.rounds',
...
'log-viewer.files.download','log-viewer.index','loginLinkLogin','api.logout',
'api.products.index','api.products.store','api.products.show','api.products.update','api.products.destroy',
'api.customers.index','api.customers.store','api.customers.show','api.customers.update','api.customers.destroy',
'api.orders.index','api.orders.store','api.orders.show','api.orders.update','api.orders.destroy',
'fallback','login','logout','register','password.request',
'password.email','password.reset','password.update','password.confirm',
'home','profile.show','profile.update','toggle.theme','admin.home',
'roles.index','roles.create','roles.store','roles.edit','roles.update',
'users.index','users.create','users.store','users.edit','users.update',
'users.destroy','customers.index','customers.create','customers.store','customers.show',
'customers.edit','customers.update','customers.destroy','products.index','products.show',
'products.create','orders.index','orders.show','orders.create',);
...
'components.common.product-icon','components.status-card','customers.create','customers.edit','customers.index',
'customers.show','errors.419','errors.minimal','errors.settings.missing','home',
'home_admin','layouts.app','layouts.guest','layouts.navigation','livewire.dashboard-container',
'livewire.order-create','livewire.order-index','livewire.order-show','livewire.ordini-chart','livewire.product-create',
'livewire.product-delete','livewire.product-edit','livewire.product-index','livewire.product-list-create-order','livewire.product-show',
'livewire::bootstrap','livewire::simple-bootstrap','livewire::simple-tailwind','livewire::tailwind','login-link::loginLink',
'login-link::loginLinkButton','mail.test','preview','roles.create','roles.edit',
'roles.index','sweetalert::alert','users.create','users.edit','users.index',
'vendor.livewire.bootstrap','vendor.livewire.simple-bootstrap','vendor.livewire.simple-tailwind','vendor.livewire.tailwind','vendor.login-link.loginLink',
'vendor.login-link.loginLinkButton','vendor.sweetalert.alert','volt-livewire::dashboard-container','volt-livewire::order-create','volt-livewire::order-index',
'volt-livewire::order-show','volt-livewire::ordini-chart','volt-livewire::product-create','volt-livewire::product-delete','volt-livewire::product-edit',
