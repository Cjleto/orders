<div x-data="{
    ...
    <style>
        ...
        .accordion-custom {
            border: 0px solid {{ $this->menuSetting->secondary_color }};
    ...
    <div class="d-flex justify-content-center">
        @if ($this->logo)
            <img src="{{ $this->logo }}" alt="{{ $company['name'] }}" class="mx-auto img-fluid"
    ...
    <div class="container mt-5" style="text-transform: uppercase;">
            ...
            @foreach ($menuMap as $record)
                ...
                <li class="nav-item" role="presentation">
                    <button
                        ...
                        aria-selected="{{ $loop->first ? 'true' : '' }}">{{ Str::upper($record['macro_obj']->getTranslatedValue('name')) }}</button>
                </li>
            @endforeach
        </ul>
                                ...
                                <div id="flush-collapse-{{ $slugCategory }}" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body accordion-body-custom">
                                        ...
                                        @foreach ($category['sub_categories'] as $sub_category)
                                            ...
                                            <div class="mt-2 font-bigger chosen_secondary_color">
                                                ...
                                                <div class="dish-row-container">
                                                    ...
                                                    <div class="mt-2 row">
                                                        <div
                                                            ...
                                                            @endif
                                                            <strong
                                                                class="">{{ $dish->translated_name }}</strong>
                                                        </div>
                                            ...
                                            <div class="dish-row-container">
                                                ...
                                                <div class="mt-2 row">
                                                    <div class="col-8 d-flex justify-content-start align-items-center">
                                                        ...
                                                        <strong class="">{{ $dish->translated_name }}</strong>
                                                    </div>
                                                    <div class="col-4 text text-end align-content-center ">
                                                        <strong>{{ $dish['price'] }}</strong>
                                                    </div>
        ...
        <div class="d-flex justify-content-center flex-column align-items-center">
            ...
            <x-menulight-footer class="p-0 m-2 text-light-emphasis d-none" />
        </div>
