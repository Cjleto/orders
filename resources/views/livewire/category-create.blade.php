<div>
    ...
    <button type="button" class="{{ $btnClass }}" data-coreui-toggle="modal"
        data-coreui-target="#createCategoryModal">
    ...
    <!-- Modal -->
    <div wire:ignore.self class="modal modal-xl fade" id="createCategoryModal" tabindex="-1"
        aria-labelledby="createCategoryModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title text-secondary" id="createCategoryModalLabel">{{ __('Create Category') }}</h5>
